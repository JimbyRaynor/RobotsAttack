...
STEPD = 4 # speed of characters. This changes dx,dy.
...
myship = LEDlib.LEDobj(canvas1,STARTX,STARTY,dx = 0,dy = 0,CharPoints=charRobotron, pixelsize = 2,typestring = "human")
